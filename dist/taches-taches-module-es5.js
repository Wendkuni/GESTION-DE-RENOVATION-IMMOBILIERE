(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["taches-taches-module"], {
    ...
    /***/
    function BgE4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TachesComponent", function () {
        return TachesComponent;
      });
      /* harmony import */


      var _raw_loader_taches_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! raw-loader!./taches.component.html */
      "Lmox");
      /* harmony import */


      var _taches_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./taches.component.scss */
      "TzIp");
      /* harmony import */


      var _gestion_taches_gestion_taches_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./gestion-taches/gestion-taches.component */
      "dppI");
      /* harmony import */


      var _projet_user_user_projet_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./../projet-user/user-projet.service */
      "D2DK");
      /* harmony import */
      ...
      var src_app_shared_services_SnackBar__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! src/app/shared/services/SnackBar */
      "77k+");
      /* harmony import */


      var src_app_shared_utils_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! src/app/shared/utils/app-confirm/app-confirm.service */
      "iN25");
      /* harmony import */


      var _gestion_taches_services__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./gestion-taches.services */
      "q1+a");
      /* harmony import */


      var _update_taches_update_taches_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./update-taches/update-taches.component */
      "OEg8");
      /* harmony import */
      ...
      var _demarrage_projet_renovation_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../demarrage-projet-renovation.component */
      "mgTU");
      /* harmony import */


      var _login_helper_localStorage__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ../../login/_helper/localStorage */
      "+64y");
      /* harmony import */


      var src_app_shared_services_ProjetRenovation_localStorage__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! src/app/shared/services/ProjetRenovation.localStorage */
      "Geum");
      /* harmony import */


      var src_app_theme_utils_app_animation__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! src/app/theme/utils/app-animation */
      "NObv");
      ...
      var TachesComponent = /*#__PURE__*/function () {
        function TachesComponent(appSettings, route, userTache, projetStorage, tacheService, router, tokenService, dialog, confirm, snackBar) {
          ...
          this.Gerant = parseInt(projetStorage.getGestionTache()); // this.id = this.route.snapshot.params.id;
        ...
        _createClass(TachesComponent, [{
          ...
          key: "elementUser",
          value: function elementUser() {
            var _this = this;

            this.isLoadingResults = true;
            this.userTache.gettachess(this.projet.id).subscribe(function (data) {
              _this.tacheList = data;
              _this.dataSources = new _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableDataSource"](_this.tacheList);

              _this.tacheList.forEach(function (tache, index) {
                if (tache.niveauAvancer == 'VALIDER') {
                  _this.valider.push(tache);
                } else if (tache.niveauAvancer === 'ENCOURS') {
                  _this.enCours.push(tache);
                } else if (tache.niveauAvancer == 'AREFAIRE') {
                  _this.aReFaire.push(tache);
                } else {
                  _this.aFaire.push(tache);
                }
              ...
              if (error.status > 300) {
                _this.router.navigate([src_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].FRONTEND_ROUTES.DASHBOARD]);
              }
            });
          }
        }, {
          key: "nombreJour",
          value: function nombreJour(tache) {
            var temps = new Date(tache.dateFinition).getTime() - new Date(tache.dateDemarrage).getTime();
            return temps / (1000 * 60 * 60 * 24);
          }
        }, {
          key: "elementGerant",
          value: function elementGerant() {
            var _this2 = this;

            this.isLoadingResults = true;
            this.tacheService.gettachess(this.projet.id).subscribe(function (data) {
              _this2.tacheList = data;
              _this2.dataSources = new _angular_material_table__WEBPACK_IMPORTED_MODULE_10__["MatTableDataSource"](_this2.tacheList);

              _this2.tacheList.forEach(function (tache, index) {
                if (tache.niveauAvancer == 'VALIDER') {
                  _this2.valider.push(tache);
                } else if (tache.niveauAvancer == 'ENCOURS') {
                  _this2.enCours.push(tache);
                } else if (tache.niveauAvancer == 'AREFAIRE') {
                  _this2.aReFaire.push(tache);
                } else {
                  _this2.aFaire.push(tache);
                }
              }); //console.log(this.dataSources);
              ...
              if (error.status > 300) {
                _this2.router.navigate([src_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].FRONTEND_ROUTES.DASHBOARD]);
              }
            });
          }
        }, {
          key: "drop",
          value: function drop(event, types) {
            var _this3 = this;
            ...
            if (event.previousContainer === event.container) {
              ...
              this.userTache.updatetaches(tache.id, tache).subscribe(function (data) {
                console.log(data);
              }, function (error) {
                if (error.status < 300) {
                  _this3.isLoadingResults = false;

                  _this3.snackBar.openSnackBar("status de la tache changer avec success", "OK", 3000);
                } else {
                  _this3.isLoadingResults = false;

                  _this3.snackBar.openSnackBar("status de la tache non changer", "OK", 3000);
          ...
          key: "onChangePourcentage",
          value: function onChangePourcentage(event, tache) {
            var _this4 = this;
            ...
            if (event > 0) {
              ...
              this.userTache.updatetaches(tache.id, tache).subscribe(function (data) {}, function (error) {
                if (error.status < 300) {
                  _this4.snackBar.openSnackBar("status de la tache changer avec success", "OK", 3000);
                } else {
                  _this4.snackBar.openSnackBar("status de la tache non changer", "OK", 3000);
          ...
          key: "supprimerAndAssigneElemet",
          value: function supprimerAndAssigneElemet(element, tab1, tab2) {
            tab1.forEach(function (t, index) {
              if (t.id = element.id) {
                console.log(index);
                tab1.splice(index, 1);
              }
          ...
          key: "openDialog",
          value: function openDialog(tache) {
            var _this5 = this;

            var dialogRef = this.dialog.open(_update_taches_update_taches_component__WEBPACK_IMPORTED_MODULE_15__["UpdateTachesComponent"], {
              width: '600px',
              data: {
                tache: tache
              },
          ...
          key: "voirPlus",
          value: function voirPlus(tache) {
            var dialogRef = this.dialog.open(_gestion_taches_gestion_taches_component__WEBPACK_IMPORTED_MODULE_2__["GestionTachesComponent"], {
              width: '600px',
              data: {
                tache: tache
              }
          ...
          value: function supprimerRenovation(index) {
            ...
            this.confirm.confirm({
              ...
              if ($choix) {
                _this6.isLoadingResults = true;

                _this6.tacheService.deletetaches(index).subscribe(function () {}, function (error) {
                  _this6.isLoadingResults = false;

                  if (error.status < 300) {
                    _this6.snackBar.openSnackBar("Element supprimé avec succès", "OK", 3000);

                    _this6.ngOnInit();
                  } else {
                    _this6.snackBar.openSnackBar("Element non supprimer ", "OK", 3000);
                  }
                });
              }
            });
      ...
      TachesComponent.ctorParameters = function () {
        return [{
      ...
      TachesComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
        selector: 'app-taches',
      ...
      }), __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_11__["AppSettings"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _projet_user_user_projet_service__WEBPACK_IMPORTED_MODULE_3__["ListTacheService"], src_app_shared_services_ProjetRenovation_localStorage__WEBPACK_IMPORTED_MODULE_19__["ProjetStorageService"], _gestion_taches_services__WEBPACK_IMPORTED_MODULE_14__["GestionTacheService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _login_helper_localStorage__WEBPACK_IMPORTED_MODULE_18__["TokenStorageService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialog"], src_app_shared_utils_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_13__["AppConfirmService"], src_app_shared_services_SnackBar__WEBPACK_IMPORTED_MODULE_12__["SnackBarService"]])], TachesComponent);
      /***/
    },
    ...
    /***/
    function Lmox(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function OEg8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UpdateTachesComponent", function () {
        return UpdateTachesComponent;
      });
      /* harmony import */


      var _raw_loader_update_taches_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! raw-loader!./update-taches.component.html */
      "RV+r");
      /* harmony import */


      var _update_taches_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./update-taches.component.scss */
      "8CHN");
      /* harmony import */
      ...
      var src_app_features_user_affecter_projet_renovation_user_affecter_projet_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/features/user-affecter-projet-renovation/user-affecter-projet.service */
      "Ta7a");
      /* harmony import */
      ...
      var _demarrage_projet_renovation_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../demarrage-projet-renovation.component */
      "mgTU");
      /* harmony import */


      var _gestion_taches_services__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../gestion-taches.services */
      "q1+a");
      /* harmony import */
      ...
      var UpdateTachesComponent = /*#__PURE__*/function () {
        function UpdateTachesComponent(confirm, dialogRef, snackBar, dialog, data, fb, tacheService) {
          _classCallCheck(this, UpdateTachesComponent);
        ...
        _createClass(UpdateTachesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this7 = this;

            this.isLoadingResults = true;
            this.tacheService.getUser(_demarrage_projet_renovation_component__WEBPACK_IMPORTED_MODULE_7__["DemarrageProjetRenovationComponent"].projetRenovation.id).subscribe(function (data) {
          ...
          value: function onSubmit() {
            ...
            this.isLoadingResults = true;
            this.tacheService.verifierTaches(this.tacheForm.value).subscribe(function (data) {
              var list = data;
              console.log(data);

              if (list.length > 0) {
                _this8.TachesExisteDeja();
              } else {
                _this8.enregistrer();
              }
            }, function (error) {
          ...
          key: "TachesExisteDeja",
          value: function TachesExisteDeja() {
            var _this9 = this;
          ...
          key: "Remeniation",
          value: function Remeniation() {
            var _this10 = this;

            this.confirm.confirm({
              title: "Comment Enregistrer la tache",
              message: " doit-on enregistrer la tache parallelement ou decaller les dates? ",
              buttun1: "Enregistr\xE9 simplement",
              buttun2: "Enregistr\xE9 avec decallage"
            }).subscribe(function ($choix) {
              if ($choix) {
                _this10.tacheForm.get('enregistre').setValue("Decaller");
              } else {
                _this10.tacheForm.get('enregistre').setValue("Parallele");
              }

              console.log(_this10.tacheForm.value);
          ...
          key: "enregistrer",
          value: function enregistrer() {
            var _this11 = this;

            if (this.data.tache) {
              this.tacheService.updatetaches(this.data.tache.id, this.tacheForm.value).subscribe(function (data) {
                ...
                if (error.status < 300) {
                  ...
                  _this11.snackBar.openSnackBar("Element modifier  avec succès", "OK", 3000);
                } else {
                  _this11.snackBar.openSnackBar("Element non Ajouter car tache existe deja", "OK", 3000);
                }
              });
            } else {
              this.tacheService.addtaches(this.tacheForm.value).subscribe(function (data) {
                //console.log(data);
                _this11.isLoadingResults = false;
              }, function (error) {
                _this11.isLoadingResults = false;
                ...
                if (error.status < 300) {
                  ...
                  _this11.snackBar.openSnackBar("Element Ajouter  avec succès", "OK", 3000);
                } else {
                  _this11.snackBar.openSnackBar("Element non Ajouter car tache existe deja", "OK", 3000);
                }
              });
      ...
      UpdateTachesComponent.ctorParameters = function () {
        return [{
      ...
      UpdateTachesComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      ...
      }), __metadata("design:paramtypes", [src_app_shared_utils_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_9__["AppConfirmService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"], src_app_shared_services_SnackBar__WEBPACK_IMPORTED_MODULE_6__["SnackBarService"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _gestion_taches_services__WEBPACK_IMPORTED_MODULE_8__["GestionTacheService"]])], UpdateTachesComponent);
      /***/
    },
    ...
    /***/
    function QWJR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TachesModule", function () {
        return TachesModule;
      });
      /* harmony import */
      ...
      var _taches_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./taches.component */
      "BgE4");
      /* harmony import */


      var _update_taches_update_taches_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./update-taches/update-taches.component */
      "OEg8");
      /* harmony import */
      ...
      var _gestion_taches_gestion_taches_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./gestion-taches/gestion-taches.component */
      "dppI");
      /* harmony import */


      var _gestion_taches_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./gestion-taches.services */
      "q1+a");
      ...
      var routes = [{
        path: '',
        component: _taches_component__WEBPACK_IMPORTED_MODULE_2__["TachesComponent"],
        data: {
          breadcrumb: 'taches'
        }
      }];

      var TachesModule = function TachesModule() {
        _classCallCheck(this, TachesModule);
      };

      TachesModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], ngx_dropzone_wrapper__WEBPACK_IMPORTED_MODULE_7__["DropzoneModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_8__["NgxPaginationModule"], _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_9__["NgSelectModule"], _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_10__["DragDropModule"]],
        providers: [_gestion_taches_services__WEBPACK_IMPORTED_MODULE_12__["GestionTacheService"]],
        exports: [_gestion_taches_gestion_taches_component__WEBPACK_IMPORTED_MODULE_11__["GestionTachesComponent"]]
      })], TachesModule);
      /***/
    },
    ...
    /***/
    function TzIp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function q1A(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "GestionTacheService", function () {
      ...
      var GestionTacheService = /*#__PURE__*/function () {
        function GestionTacheService(http) {
          _classCallCheck(this, GestionTacheService);

          this.http = http;
        }

        _createClass(GestionTacheService, [{
          key: "gettachess",
          value: function gettachess(id) {
          ...
          key: "addtaches",
          value: function addtaches(taches) {
          ...
          key: "deletetaches",
          value: function deletetaches(id) {
          ...
          key: "updatetaches",
          value: function updatetaches(id, taches) {
          ...
          key: "verifierTaches",
          value: function verifierTaches(taches) {
      ...
      GestionTacheService.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]
        }];
      };

      GestionTacheService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])], GestionTacheService);
      /***/
    }
  }]);
})();
//# sourceMappingURL=taches-taches-module-es5.js.map