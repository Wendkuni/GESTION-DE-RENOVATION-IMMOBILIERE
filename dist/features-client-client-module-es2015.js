...
/* harmony import */ var _raw_loader_client_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./client.component.html */ "RChn");
/* harmony import */ var _client_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./client.component.scss */ "aXvP");
/* harmony import */ var _client_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./client-admin-service */ "IYFT");
...
/* harmony import */ var _update_update_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./update/update.component */ "jodq");
...
let ClientComponent = class ClientComponent {
    ...
    openDialog(user) {
        const dialogRef = this.dialog.open(_update_update_component__WEBPACK_IMPORTED_MODULE_8__["UpdateClientAdminComponent"], {
            width: '600px',
            data: { user: user },
            disableClose: true
        });
...
ClientComponent = __decorate([
    ...
    __metadata("design:paramtypes", [src_app_app_settings__WEBPACK_IMPORTED_MODULE_5__["AppSettings"], src_app_shared_services_SnackBar__WEBPACK_IMPORTED_MODULE_6__["SnackBarService"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"], src_app_shared_utils_app_confirm_app_confirm_service__WEBPACK_IMPORTED_MODULE_7__["AppConfirmService"],
        _client_admin_service__WEBPACK_IMPORTED_MODULE_2__["ClientAdminService"]])
], ClientComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClientAdminService", function() { return ClientAdminService; });
...
let ClientAdminService = class ClientAdminService {
    constructor(http) {
        this.http = http;
    }
    getUsers() {
...
ClientAdminService.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateClientAdminComponent", function() { return UpdateClientAdminComponent; });
/* harmony import */ var _raw_loader_update_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./update.component.html */ "GI07");
/* harmony import */ var _update_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update.component.scss */ "k3od");
/* harmony import */ var _client_admin_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../client-admin-service */ "IYFT");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let UpdateClientAdminComponent = class UpdateClientAdminComponent {
    constructor(dialogRef, snackBar, clientServices, dialog, data, _fb) {
...
UpdateClientAdminComponent.ctorParameters = () => [
...
UpdateClientAdminComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-update',
    ...
    __metadata("design:paramtypes", [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialogRef"], src_app_shared_services_SnackBar__WEBPACK_IMPORTED_MODULE_5__["SnackBarService"], _client_admin_service__WEBPACK_IMPORTED_MODULE_2__["ClientAdminService"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialog"], Object, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]])
...
/* harmony import */ var _client_admin_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./client-admin-service */ "IYFT");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _client_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./client.component */ "3/oN");
/* harmony import */ var _update_update_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./update/update.component */ "jodq");
...
/* harmony import */ var _login_helper_AuthInterceptorService__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../login/_helper/AuthInterceptorService */ "ct3H");
/* harmony import */ var _login_helper_error_interceptor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../login/_helper/error.interceptor */ "AmT5");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
const routes = [
    { path: '', component: _client_component__WEBPACK_IMPORTED_MODULE_3__["ClientComponent"], data: { breadcrumb: 'Client' } },
];
...
ClientModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [_client_admin_service__WEBPACK_IMPORTED_MODULE_0__["ClientAdminService"],
            _login_helper_AuthInterceptorService__WEBPACK_IMPORTED_MODULE_12__["authInterceptorProviders"],
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HTTP_INTERCEPTORS"], useClass: _login_helper_error_interceptor__WEBPACK_IMPORTED_MODULE_13__["ErrorInterceptor"], multi: true },]
    })
], ClientModule);
...
//# sourceMappingURL=features-client-client-module-es2015.js.map