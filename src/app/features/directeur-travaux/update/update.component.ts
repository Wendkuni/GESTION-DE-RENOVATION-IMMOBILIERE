...
export class UpdateResponsableComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<UpdateResponsableComponent>,private snackBar: SnackBarService, private autreUserService: ResponsableEtudeAdminService,
