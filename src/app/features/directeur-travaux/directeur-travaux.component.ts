...
@Component({
  ...
  templateUrl: './directeur-travaux.component.html',
  styleUrls: ['./directeur-travaux.component.scss'],
  providers: [ResponsableEtudeAdminService]
})
export class ResponsableTravauxComponent implements OnInit {
  ...
  constructor(public appSettings:AppSettings,private snackBar: SnackBarService,
              ...
              public usersService: ResponsableEtudeAdminService){
  ...
  openDialog(user): void {
    const dialogRef = this.dialog.open(UpdateResponsableComponent, {
      width: '600px',
      data: {user: user},
      disableClose: true
    });
