...
export class UpdateBureauEtudeComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<UpdateBureauEtudeComponent>,private snackBar: SnackBarService, private autreUserService: BureauEtudeAdminService,
